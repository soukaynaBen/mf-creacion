    ...
    <div className='flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4 '>
      <div className='bg-white p-4 sm:p-8 rounded-xl shadow-lg w-full max-w-4xl'>
        <h1 className='text-4xl font-bold text-gray-900 tracking-tight mb-8'>
          ...
          { orders.length === 0 ? (<div className='text-center text-gray-600'>
              ...
              className='bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden'>
                ...
                <div className='flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center'>
                  <div className='flex items-center'>
                    ...
                    <span className={cn(order.status === "paid" ?  "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800","py-1 px-2 rounded-lg text-sm")}>{order.status}</span>
                  </div>
                    <div className='sm:text-right'>
                    ...
                    </div>
                  {
                    order.amountDiscount ? (
                      ...
                      <p className='text-red-600 font-mediun mb-1 text-sm sm:text-base'>
                        Discount Applied:{" "}
                    ...
                    <div className='space-y-3 sm:space-y-4'>
                      {
                        ...
                        className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 py-2 border-b last:border-b-0'>
                            <div className='flex items-center gap-3 sm:gap-4 '>
                              {
                                product.product?.image && (<div className='relative h-14 w-14 sm:h-16 sm:w-16 flex-shrink-0 rounded-md overflow-hidden'>
                                  <Image
